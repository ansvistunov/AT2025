...
| 2025-11-15 |   0.4.0   | Изменено требование ФТ.А.02 и добавлено требование ФТ.А.04 | Денисов А. |
---
...
|Холдинг карта        | Карта лояльности, имеющая общий счёт баллов с другими картами, входящими в один холдинг. |
...
| **Описание**  | Система должна предоставлять возможность администратору магазина временно:<br>— изменять правила начисления/списания баллов<br>— задавать условия и дополнительные скидки, применяемые при выполнении заданных условий<br>— задавать условия и информацию, дополнительно выводимую в чек, при выполнении заданных условий|
| **Приоритет** | 2 |
| **Источник**  | Интервью с заказчиком 08.11.25 |
| **Риск**      | L |
...
|-------------|----------|
| **ID**        | ФТ.А.04 |
| **Название**  | Создание холдинг карты |
| **Описание**  | Система должна предоставлять возможность администратору магазина объединить счёт баллов нескольких карт лояльности в одну холдинг карту. После объединения общий счёт баллов должен быть равен сумме счетов, к которым были привязаны карты до объединения. Система не должна позволять объединить более 100 карт лояльности в одну холдинг карту|
| **Приоритет** | 3 |
| **Источник**  | Интервью с заказчиком 08.11.25 |
| **Риск**      | L |
