...
## Цели
Система поддержки тендерных решений (TSS - Tender Support System) предоставляет единую среду для работы с конкурсной документацией, ведения нормативно-справочной информации (работы, материалы, расценки) и формирования сметной документации. Ключевая задача системы — быстро предоставить техническому директору точный расчёт себестоимости проекта для принятия взвешенного решения о подаче заявки, минимизируя коммерческие риски и исключая ошибки ручного учёта.
