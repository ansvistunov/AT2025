...
Этот раздел содержит в себе все требования к программному обеспечению. Функциональные требования имеют следующую структуру: требования разделены по ролям пользователей, которые перечисляются подряд, и под каждым пунктом с названием роли есть один или несколько подпунктов с описанием функциональных требований для данной роли.
## Функциональные требования
### 3.2.1 Специалист по лицензированию

3.2.1.1 Пользователь должен иметь возможность вносить информацию о лицензии в базу данных вручную, посредством специальной формы в пользовательском интерфейсе.

3.2.1.2 Пользователь должен иметь возможность удалять информацию о лицензии в базе данных.

3.2.1.3 Пользователь должен иметь возможность модифицировать информацию о лицензии в базе данных посредством специальной формы.

3.2.1.4 Пользователь должен иметь возможность получать информацию о выбранной лицензии из базы данных в виде документа в форматах, оговоренных пункте “Ограничения” в Общем описании изделия, где должны содержаться все сведения, хранимые о данной лицензии в базе данных.

3.2.1.5 Пользователь должен иметь возможность генерировать с помощью системы различные аналитические отчёты, описанные в пункте “Формирование отчётов” в разделе Общее описание изделия.

### 3.2.2 Документовед

3.2.2.1 Пользователь должен иметь возможность получать информацию о выбранной лицензии из базы данных в виде документа в форматах, оговоренных пункте “Ограничения” в Общем описании изделия.

3.2.2.2 Пользователь должен иметь возможность генерировать с помощью системы различные аналитические отчёты, описанные в пункте “Формирование отчётов” в Общем описании изделия.
