...
нефункциональные требования к системе, среду работу и ограничения ПО и характеристики пользователей системы.
...
| Переназначение                | **Назначени**, при котором сотрудник передаёт назначенное ему **Поручение** своему **Подчинённому** |
